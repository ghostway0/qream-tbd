...
int main() {
  std::vector<Operation> ops = {
      Operation{0,
                ...
                VectorShape::Scalar,
                ScalarDType::Int64,
                {Access{AccessType::W, Space::Register, 7},
                 Access{AccessType::R, Space::Register, 1},
                 Access{AccessType::R, Space::Register, 2}},
                3},
      Operation{1,
                IROp::Sub,
                VectorShape::Scalar,
                ScalarDType::Int64,
                {Access{AccessType::W, Space::Register, 3},
                 Access{AccessType::R, Space::Register, 1},
                 Access{AccessType::R, Space::Register, 2}},
                3},
      Operation{2,
                ...
                VectorShape::Scalar,
                ScalarDType::Int64,
                {Access{AccessType::W, Space::Register, 4},
      ...
      Operation{3,
                ...
                VectorShape::Scalar,
                ScalarDType::Int64,
                {Access{AccessType::W, Space::Register, 5},
                 Access{AccessType::R, Space::Register, 1},
                 Access{AccessType::R, Space::Register, 2}},
                3},
      Operation{4,
                ...
                VectorShape::Scalar,
                ScalarDType::Int64,
                {Access{AccessType::W, Space::Register, 6},
                 Access{AccessType::R, Space::Register, 1}},
                2},
  };
